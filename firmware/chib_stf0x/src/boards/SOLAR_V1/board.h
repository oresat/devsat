...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_OPENDRAIN(GPIOB_PIN0_NC) |     \
                                     PIN_OTYPE_OPENDRAIN(GPIOB_PIN0_NC) |     \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLDOWN(GPIOB_PIN0_NC) |       \
                                     PIN_PUPDR_PULLDOWN(GPIOB_PIN0_NC) |       \
