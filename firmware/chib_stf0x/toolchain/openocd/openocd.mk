...
gdb_ocd: GDB_CFG = $(NUCLEO32_OPENOCD)/gdboocd_ocd.cmd
gdb_ocd: gdb_base

gdb_stl: GDB_CFG = $(NUCLEO32_OPENOCD)/gdboocd_stl.cmd
gdb_stl: gdb_base

cgdb_stl: GDB_CFG = $(NUCLEO32_OPENOCD)/gdboocd_stl.cmd
cgdb_stl: cgdb_base
